...
$response = $_POST['number']; // On récupére le nombre d'unités d'un territoire ici, pour ensuite le déplacer dans l'autre territoire
...
<body>
	...
	<div class="area" id="area2" value=<?php if (isset($response)) print $response; else  ?> onclick="putUnit()"> 
